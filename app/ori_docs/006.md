...
AutoAWQ 在**无需训练数据、异常激活鲁棒性、硬件优化**等方面全面领先。
...
* **3-bit、2-bit 量化**：进一步压缩模型，降低硬件门槛。
* **动态量化**：根据输入内容动态调整量化策略。
* **与 LoRA、Adapter 等技术融合**：打造轻量、高效、可微调的模型部署方案。
...
![](http://mmbiz.qpic.cn/sz_mmbiz_png/j5qJicU7r8hZradZia7iaCulRcuXkiam3OllwQFfc6At4wPbs1wKibNvEEXBIJJsnG8ovbO3wEHZm5tAuNnPwMYv8KA/0?wx_fmt=png)
...
![作者头像](http://mmbiz.qpic.cn/sz_mmbiz_png/j5qJicU7r8hZradZia7iaCulRcuXkiam3OllwQFfc6At4wPbs1wKibNvEEXBIJJsnG8ovbO3wEHZm5tAuNnPwMYv8KA/0?wx_fmt=png)
