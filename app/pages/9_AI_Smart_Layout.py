...
# 修复路径问题，使用绝对路径
TEMPLATE_DIR = os.path.join(parent_dir, "html_template_with_llm_convert")
HTML_TEMPLATES_DIR = os.path.join(parent_dir, "html_templates")
...
# 读取端点
ENDPOINTS_PATH = os.path.join(parent_dir, "llm_endpoints.json")
